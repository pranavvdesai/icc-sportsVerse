      ...
      <div className="grid grid-cols-2 gap-4 m-10">
        <div className="grid grid-cols-3 gap-4 ">
          <div>
            ...
            <h1 className="text-white mt-2">Required avatar level: 75</h1>
          </div>
          <div>
            <div class="relative custom-gray shadow-lg rounded-lg py-5 overflow-hidden">
              <div class=" h-full w-full absolute bottom-0 opacity-40">
            ...
            <h1 className="text-white mt-2">Required avatar level: 50</h1>
          </div>
          <div>
            <div class="relative custom-gray shadow-lg rounded-lg py-5 overflow-hidden">
              <div class=" h-full w-full absolute bottom-0 opacity-40">
            ...
            <h1 className="text-white mt-2 ">Required avatar level: 30</h1>
          </div>
        </div>
          <div class="relative custom-gray shadow-lg rounded-lg py-5 overflow-hidden">
            <div class=" h-full w-full absolute bottom-0 opacity-40">
